 ...
 * @author diego
 */
public class estadisticaId extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int k_idvehiculo = Integer.valueOf(request.getParameter("k_idvehiculo"));
        
        servicio.setK_idvehiculo(k_idvehiculo);

        ArrayList<Servicio> count = gestor.buscarServiciPorVehiculo();
        
        lol.setAttribute("count", count);
        
        response.sendRedirect("estadisticaId.jsp"); 
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(estadisticaId.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
